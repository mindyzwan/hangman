defmodule Hangman.Impl.Game do
  ...
  def make_move(game, guess) do
    accept_guess(game, guess, MapSet.member?(game.used, guess), guess =~ ~r/^[a-z]$/)
    |> return_with_tally()
  end
  ...
  defp accept_guess(game, _guess, _already_used, _is_not_valid) do
    %{ game | game_state: :invalid_guess }
  end

  defp score_guess(game, _good_guess = true) do
    # guessed all? :won, otherwise, :good_guess
  ...
  defp maybe_won(_all_guessed = true) do
    :won
  end

  defp maybe_won(_not_yet_won) do
    :good_guess
  end
